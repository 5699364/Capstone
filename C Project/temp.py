...
Version: 7.9.1 - Enterprise Edition (FINAL)

MODIFICATIONS:
1. Turbidity optimal set to 0.27 NTU (instead of 0.10)
2. All pages restored and functional
...
WATER_QUALITY_STANDARDS = {
    "max_turbidity": 0.30,
    "optimal_turbidity": 0.27,
    "warning_turbidity": 0.28,
}
...
def sync_parameters_with_day(day_number, beer_profile):
    ...
    turbidity = data.get('water_turbidity', 0.27)
...
if nav_page == "🏭 Main Dashboard":
    ...
    with col4:
        ...
        <div class="dashboard-card" style="text-align: center;">
            ...
            <div style="margin-top: 10px;">Based on pH + Temperature + Turbidity</div>
        </div>
        """, unsafe_allow_html=True)
    ...
    col8.metric("💧 Turbidity", f"{data.get('water_turbidity', 0.27):.2f} NTU", 
...
# =================================================================================
    ...
    st.caption(f"Current water turbidity: {st.session_state.fermentation_data.get('water_turbidity', 0.27):.2f} NTU")
